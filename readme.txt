=== Ultimate Member - WP Job Manager integration ===
Author URI: https://vantageplugins.com
Plugin URI: https://wordpress.org/plugins/um-wpjm/
Contributors: badomn83
...
Integrates Ultimate Member with WP Job Manager listings plugin

== Description ==

Ultimate Member - WP Job Manager integration is an easy to use and lightweight plugin that enables you to add integration between job board functionality and user profiles to your website.
...
* Show account tab with jobs dashboard ( Ultimate Member > Settings > Extensions > WP Job Manager );
* Show profile tab with the user's jobs list ( Ultimate Member > Settings > Appearance > Profile Menu generally and for every role Ultimate Member > User Roles > Edit > WP Job Manager metabox);
...
Got a problem or need help with Ultimate Member - WP Job Manager? Head over to our [documentation](https://docs.ultimatemember.com/category/1573-jobboardwp) and perform a search of the knowledge base. If you can’t find a solution to your issue then you can create a topic on the [support forum](https://wordpress.org/support/plugin/um-wpjm/).

== Installation ==

1. Activate the plugin
2. That's it. Go to Ultimate Member > Settings > Extensions > WP Job Manager to customize plugin options
